...
export function ResidencialForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        // Track events
        trackEvent("Lead", { content_name: "Residencial Landing" });
        trackGA4Event("generate_lead", { content_name: "Residencial Landing" });
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Button
        ...
        className="w-full"
      >
        {loading ? "Enviando..." : "Solicita tu presupuesto gratis"}
      </Button>
    </form>
  );
}
